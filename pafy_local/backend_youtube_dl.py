...
class YtdlPafy(BasePafy):
    ...
    def _fetch_basic(self):
        ...
        self._likes = self._ydl_info['like_count'] if 'like_count' in self._ydl_info.keys() else 0
        self._dislikes = self._ydl_info['dislike_count'] if 'dislike_count' in self._ydl_info.keys() else 0
